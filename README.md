# Proposal Master — 웹사이트 템플릿 사용 설명서

> 🧠 프리미엄 랜딩 페이지 + Firebase 인증 + PayPal 결제 — 올인원 템플릿
...
📄 파일: `src/components/ProposalMasterLogo.tsx`
...
**Q: 결제는 PayPal만 쓰나요?**
A: 네. 현재 템플릿은 PayPal 결제만 사용하도록 정리되어 있습니다.
